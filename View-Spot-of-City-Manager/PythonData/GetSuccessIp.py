...
headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.3 (KHTML, like Gecko) Ubuntu Chromium/56.0.2924.7 Chrome/56.0.2924.76 Safari/537.36'}
...
def get_proxies():
    ...
    for page in range(1,5):
        html = requests.get('http://www.xicidaili.com/nn/'+str(page), headers=headers).text
